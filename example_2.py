...
if __name__ == "__main__":
    ...
    Crytsal, a 35 years old mom, is looking for tips and ideas to plan for her family vacation in Hawaii; 
    she is trying to get some suggestions from an AI assistant. 
    ...
    mom = Player(name="Crytsal", backend=OpenAIChat(),
                    role_desc="""
                    You are a 35 years old mom, is asking for Siri's suggestions for your family vacation in Hawaii; 
                    you will provide your feedback to Siri's suggestions or ask a follow up question.""",
