...
if __name__=="__main__": 
    ...
    user = Player(name="Crystal", backend=OpenAIBackend(),
                 role_desc="""
                 You are exploring suggestions and ideas for quick and healthy school lunch ideas for your daughter. 
                 You will provide your feedback to responses from the AI assistant; you can also ask follow up questions.
                 """,
    ...
    moderator = Player(name="Ella", backend=OpenAIBackend(), 
                       ...
                       1. If Nova has provided answers to all the asks from Crystal and Crystal is satisfied with the answer from Nova, then converstation can end. 
